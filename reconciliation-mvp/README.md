...
This project provides a modular, Dockerized microservice architecture for ingesting ledger transactions, reconciling them with deterministic logic, flagging anomalies with an AI endpoint placeholder, and exporting daily ledger reports.
...
Run tests in reconciliation engine:
